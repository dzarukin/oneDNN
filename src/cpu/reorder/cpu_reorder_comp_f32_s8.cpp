...
const impl_list_map_t comp_f32_s8_impl_list_map REG_REORDER_P({
    // f32 -> s8
    {{f32, s8, 2}, {
    ...
    {{f32, s8, 3}, {
        ...
        REG_SR(f32, iwo, s8, OIw4i64o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, iwo, s8, OIw2i8o4i, fmt_order::keep, spec::conv_req_comp)
    ...
    {{f32, s8, 4}, {
        ...
        REG_SR(f32, ihwo, s8, OIhw4i16o4i, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, ihwo, s8, OIhw4i32o4i, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, ihwo, s8, OIhw4i64o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, ihwo, s8, OIhw2i8o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, ihwo, s8, OIhw4o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, ihwo, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, oihw, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, hwio, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, ihwo, s8, OhwI16o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, ihwo, s8, OIhw16i16o4i, fmt_order::keep, spec::conv_req_comp)
    ...
    {{f32, s8, 5}, {
        ...
        REG_SR(f32, idhwo, s8, OIdhw4i16o4i, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, idhwo, s8, OIdhw4i32o4i, fmt_order::keep, spec::conv_req_comp)
        REG_SR(f32, idhwo, s8, OIdhw4i64o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, idhwo, s8, OIdhw2i8o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, idhwo, s8, OIdhw4o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, idhwo, s8, OdhwI16o4i, fmt_order::keep, spec::conv_req_comp)
        ...
        REG_SR(f32, idhwo, s8, OIdhw16i16o4i, fmt_order::keep, spec::conv_req_comp)
    ...
    {{f32, s8, 6}, {
        ...
        REG_SR(f32, goidhw, s8, gOIdhw16i16o4i, fmt_order::keep, spec::conv_req_comp)
        nullptr,
    }},
});
